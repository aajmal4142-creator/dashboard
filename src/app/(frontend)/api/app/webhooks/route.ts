...
/**
 * POST /api/app/webhooks — register outbound webhook (incl. report.generated)
 * GET  /api/app/webhooks — list registrations for active org
 */
    ...
    return NextResponse.json(
      {
        ...
        headers: webhook.headers ? Object.keys(webhook.headers) : [],
        has_authentication: Boolean(webhook.authentication),
  ...
  try {
    ...
    return NextResponse.json({
      ...
      webhooks: webhooks.map((w) => ({
        ...
        header_keys: w.headers ? Object.keys(w.headers) : [],
        has_authentication: Boolean(w.authentication),
